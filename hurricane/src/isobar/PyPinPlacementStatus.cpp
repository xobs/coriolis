...
//PyTypeObjectLinkPyType(Transformation::PinPlacementStatus)
  ...
  DirectRichcmpMethod (PyPinPlacementStatus_Richcmp,IsPyPinPlacementStatus,PyPinPlacementStatus)
  ...
  extern void  PyPinPlacementStatus_LinkPyType() {
    ...
    PyTypePinPlacementStatus.tp_richcompare=(richcmpfunc)PyPinPlacementStatus_Richcmp;
